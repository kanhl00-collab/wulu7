...
class BlockCommand extends Command {
    ...
    /*
     Adds customer to customers, adds home to homes, ... , etc.
     Makes record in each arrayLists according to type.
     */
    @Override
    void run(Database database) throws ParseException {
        if (blockType.equals(Customer.inputTag)) {
            ...
            //cases: claim is successful or not
    ...
    //method to determine if a claim is valid
